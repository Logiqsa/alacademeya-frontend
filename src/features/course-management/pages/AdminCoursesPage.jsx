                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 rounded-lg bg-[#7F1D1D] px-3 py-2 text-xs font-bold text-white transition hover:bg-[#661515] disabled:cursor-not-allowed disabled:bg-[#7F1D1D] disabled:text-white"
                        >
                          <Trash2 size={15} />
                          حذف
                        </button>
                        ...
                        <td className="px-5 py-4">
                          <div className="flex items-center gap-2">
                            <button
                              ...
                              className="inline-flex items-center gap-2 rounded-xl bg-[#7F1D1D] px-4 py-2.5 font-bold text-white transition hover:bg-[#661515] disabled:cursor-not-allowed disabled:bg-[#7F1D1D] disabled:text-white"
                            >
            ...
            >
              ...
              <div className="mt-6 flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={Boolean(deletingCourseId)}
                  className="inline-flex items-center gap-2 rounded-xl bg-red-700 px-5 py-2.5 font-bold text-white transition hover:bg-red-800 disabled:opacity-60"
                >
                  {deletingCourseId && (
