...
export default function InlineCourseQuiz({ courseId, quizId, onClose, onCompleted, onCompleteLesson, completionLabel = 'إكمال الدرس الحالي' }) {
