    ...
    return (
        <section
            ...
            <div className="max-w-6xl mx-auto px-4 text-center">
                <h2 className="font-['Tajawal'] font-bold text-[48px] leading-14 text-[#123C91] p-2 rounded-lg text-center">
                    الباقات و الأسعار
                </h2>
                <p className="font-['IBM_Plex_Sans_Arabic'] font-normal text-[18px]  -mt-4 leading-6 text-[#1F2937B2] p-4 rounded-lg text-center mb-2">
