    ...
    <section className="py-20 font-sans bg-gray-50" dir="rtl" id="blog">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-4 flex items-center justify-center gap-3">
          <span className="w-8 h-[2px] bg-[#123C91]"></span>
          <span className="font-['IBM_Plex_Sans_Arabic'] text-[14px] text-[#123C91] font-semibold">
            المدونة التعليمية
          </span>
          <span className="w-8 h-[2px] bg-[#123C91]"></span>
        </div>
        ...
        <div className="text-center mb-12">
          <h2 className="font-['Tajawal'] font-bold text-[48px] text-[#1F2937] mb-4">
            أحدث المقالات
          </h2>
          <p className="font-['IBM_Plex_Sans_Arabic'] text-[18px] text-[#1F2937B2]">
        ...
        <div className="text-center mt-12">
          <Link
            to="/blogs"
            className="inline-block px-8 py-3 border-2 border-[#123C91] text-[#123C91] rounded-lg font-bold hover:bg-[#123C91] hover:text-white transition-all"
          >
            عرض كل المقالات
          </Link>
        </div>
