...
const faqs = [
  ...
  {
    q: "هل توفر المنصة واجبات واختبارات؟",
    a: "نعم، يستطيع المدرسون إنشاء واجبات واختبارات للطلاب، مع إمكانية التصحيح اليدوي أو التصحيح التلقائي للأسئلة متعددة الاختيارات.",
  },
  {
