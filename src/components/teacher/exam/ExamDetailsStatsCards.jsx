...
const ExamDetailsStatsCards = ({ stats }) => {
  if (!stats) return null;

  const cards = [
    { label: "لم يؤد الاختبار", value: stats.notStarted, color: "text-orange-500", bg: "bg-orange-50", icon: ClipboardList },
    { label: "مكتمل", value: stats.completed, color: "text-green-600", bg: "bg-green-50", icon: CheckCircle2 },
...
export default ExamDetailsStatsCards;