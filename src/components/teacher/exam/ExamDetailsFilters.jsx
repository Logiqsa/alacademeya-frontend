...
const STATUS_OPTIONS = ["جميع الطلاب", "أكمل الاختبار", "لم يؤد الاختبار"];

const ExamDetailsFilters = ({ search, onSearchChange, filterStatus, onFilterStatusChange }) => {
  return (
...
export default ExamDetailsFilters;