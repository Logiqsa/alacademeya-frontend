...
const SubmissionCount = ({ value }) => {
    ...
    return (
        <span style={{ fontFamily: "IBM Plex Sans Arabic, sans-serif", fontSize: "16px" }}>
...
const CorrectionModal = ({ student, onClose, onSubmit }) => {
    ...
    return (
        ...
        >
            ...
            >
                {/* Header — title/icon on the right, close (X) on the left, matching the design */}
                ...
                <div className="px-6 pb-6 space-y-5">
                    ...
                    <div className="border border-gray-200 rounded-xl flex items-center justify-between px-4 py-4">
                        ...
                        <button
                            className="border border-gray-200 rounded-xl px-7 py-2 text-xl font-medium text-[#575F69] hover:bg-gray-50 transition-colors"
