...
import { BookOpen, Clock, Calendar, Paperclip, ArrowRight, ChevronDown } from "lucide-react";
  ...
  return (
    <TeacherLayout>
      ...
      >
        ...
        {/* مرفقات الحصة */}
        <div className="flex items-center justify-between gap-4 mt-6 pt-6 border-t border-gray-100">
