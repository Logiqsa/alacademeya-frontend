...
const STATUS_OPTIONS = ["جميع الحالات", "نشط", "متوقف"];

const SupervisorsFilters = ({
  search,
  onSearchChange,
  filterStatus,
  ...
  return (
    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mb-1" dir="rtl">
      {/* Search */}
      ...
      {/* Status filter */}
      <div className="relative w-full sm:w-52" style={{ height: "48px" }}>
        <select
          value={filterStatus}
...
export default SupervisorsFilters;