...
const isApprovedStatus = (status) => ["approved", "active", "accepted"].includes(status);
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-0 border border-[#1F293733] rounded-lg overflow-hidden">
                            <button
                                ...
                                className={`h-12 text-[14px] font-medium transition-colors ${studyLanguage === "ar"
                            ...
                            <button
                                ...
                                className={`h-12 text-[14px] font-medium transition-colors border-r border-[#1F293733] ${studyLanguage === "en"
                                    ? "bg-[#123C91] text-white"
                                    : "bg-white text-[#6B7280] hover:bg-[#F9FAFA]"
                                    }`}
                            >
